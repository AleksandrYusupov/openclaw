...
- In strict mode, use `allowedHostnames` for explicit exceptions, including wildcard patterns such as `*.example.com` and otherwise-blocked names like `localhost`.
